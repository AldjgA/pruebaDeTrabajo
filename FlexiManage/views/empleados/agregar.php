...
<body>
    <div class="container">
        ...
        <form action="../../controllers/EmpleadoController.php" method="POST" id="formEmpleado">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="horario" name="horario_id" required>
                    ...
                    while ($horario = $result->fetch_assoc()) {
                        echo "<option value='" . $horario['id'] . "'>" . $horario['nombre'] . " (" . $horario['hora_inicio'] . " - " . $horario['hora_fin'] . ")</option>";
                    }
                    ?>
                </select>
            </div>
